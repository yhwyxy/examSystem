...
- Generated: `2026-07-12T13:04:21.118600+00:00`
...
- Band hit rate: `89.4%`
- Mean absolute error: `4.911`
- Ordering accuracy: `92.0%`
- Scoring errors: `0`
...
| validation-fundamentals | 基础卷-同义改写 | paraphrase | fund-rest | 8.0-10.0 | 4.1 | no | subjective_scoring:TextRerankerScorer | 0.4139 |
| validation-fundamentals | 基础卷-同义改写 | paraphrase | fund-status | 8.0-10.0 | 6.7 | no | subjective_scoring:TextRerankerScorer | 0.4000 |
| validation-fundamentals | 基础卷-部分正确 | partial | fund-choice | 0.0-0.0 | 0.0 | yes | objective_rule | 1.0000 |
| validation-fundamentals | 基础卷-部分正确 | partial | fund-rest | 3.0-5.0 | 5.2 | no | subjective_scoring:TextRerankerScorer | 0.5109 |
| validation-fundamentals | 基础卷-部分正确 | partial | fund-status | 4.0-7.0 | 9.1 | no | subjective_scoring:TextRerankerScorer | 0.9130 |
| validation-fundamentals | 基础卷-错误答案 | wrong | fund-choice | 0.0-0.0 | 0.0 | yes | objective_rule | 1.0000 |
| validation-fundamentals | 基础卷-错误答案 | wrong | fund-rest | 0.0-2.0 | 0.0 | yes | subjective_scoring:TextRerankerScorer | 0.0096 |
| validation-fundamentals | 基础卷-错误答案 | wrong | fund-status | 0.0-1.0 | 0.0 | yes | subjective_scoring:TextRerankerScorer | 0.0123 |
| validation-backend | 后端卷-完整答案 | complete | back-tx | 9.0-10.0 | 8.7 | no | subjective_scoring:TextRerankerScorer | 0.4000 |
...
| validation-backend | 后端卷-部分正确 | partial | back-tx | 3.0-5.0 | 4.5 | yes | subjective_scoring:TextRerankerScorer | 0.4000 |
...
| validation-backend | 后端卷-错误答案 | wrong | back-tx | 0.0-2.0 | 1.7 | yes | subjective_scoring:TextRerankerScorer | 0.2694 |
...
| text-scoring-specialist | 文本主观题评分专项卷-complete | complete | text-1 | 0.0-20.0 | 7.2 | yes | subjective_scoring:TextRerankerScorer | 0.4000 |
...
| text-scoring-specialist | 文本主观题评分专项卷-complete | complete | text-3 | 0.0-20.0 | 7.0 | yes | subjective_scoring:TextRerankerScorer | 0.4000 |
| text-scoring-specialist | 文本主观题评分专项卷-complete | complete | text-4 | 0.0-20.0 | 10.4 | yes | subjective_scoring:TextRerankerScorer | 0.4000 |
| text-scoring-specialist | 文本主观题评分专项卷-complete | complete | text-5 | 0.0-20.0 | 17.8 | yes | subjective_scoring:TextRerankerScorer | 0.8881 |
| text-scoring-specialist | 文本主观题评分专项卷-partial | partial | text-1 | 0.0-20.0 | 13.9 | yes | subjective_scoring:TextRerankerScorer | 0.4000 |
| text-scoring-specialist | 文本主观题评分专项卷-partial | partial | text-2 | 0.0-20.0 | 5.6 | yes | subjective_scoring:TextRerankerScorer | 0.2866 |
| text-scoring-specialist | 文本主观题评分专项卷-partial | partial | text-3 | 0.0-20.0 | 4.8 | yes | subjective_scoring:TextRerankerScorer | 0.2862 |
| text-scoring-specialist | 文本主观题评分专项卷-partial | partial | text-4 | 0.0-20.0 | 11.9 | yes | subjective_scoring:TextRerankerScorer | 0.4000 |
| text-scoring-specialist | 文本主观题评分专项卷-partial | partial | text-5 | 0.0-20.0 | 9.2 | yes | subjective_scoring:TextRerankerScorer | 0.4603 |
| text-scoring-specialist | 文本主观题评分专项卷-wrong | wrong | text-1 | 0.0-20.0 | 3.9 | yes | subjective_scoring:TextRerankerScorer | 0.2023 |
| text-scoring-specialist | 文本主观题评分专项卷-wrong | wrong | text-2 | 0.0-20.0 | 1.7 | yes | subjective_scoring:TextRerankerScorer | 0.0933 |
| text-scoring-specialist | 文本主观题评分专项卷-wrong | wrong | text-3 | 0.0-20.0 | 8.3 | yes | subjective_scoring:TextRerankerScorer | 0.4000 |
| text-scoring-specialist | 文本主观题评分专项卷-wrong | wrong | text-4 | 0.0-20.0 | 1.3 | yes | subjective_scoring:TextRerankerScorer | 0.1348 |
| text-scoring-specialist | 文本主观题评分专项卷-wrong | wrong | text-5 | 0.0-20.0 | 11.6 | yes | subjective_scoring:TextRerankerScorer | 0.5841 |
...
| code-scoring-specialist | Python 代码评分专项卷-complete | complete | code-3 | 0.0-20.0 | 19.9 | yes | subjective_scoring:CodeHybridScorer | 0.9937 |
