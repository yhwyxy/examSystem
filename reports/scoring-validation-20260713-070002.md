...
- Generated: `2026-07-12T23:00:02.652567+00:00`
...
| validation-fundamentals | 基础卷-同义改写 | paraphrase | fund-rest | 8.0-10.0 | 2.4 | no | subjective_scoring:TextRerankerScorer | 0.5500 |
| validation-fundamentals | 基础卷-同义改写 | paraphrase | fund-status | 8.0-10.0 | 5.5 | no | subjective_scoring:TextRerankerScorer | 0.4000 |
| validation-fundamentals | 基础卷-部分正确 | partial | fund-choice | 0.0-0.0 | 0.0 | yes | objective_rule | 1.0000 |
| validation-fundamentals | 基础卷-部分正确 | partial | fund-rest | 3.0-5.0 | 4.0 | yes | subjective_scoring:TextRerankerScorer | 0.8892 |
| validation-fundamentals | 基础卷-部分正确 | partial | fund-status | 4.0-7.0 | 9.1 | no | subjective_scoring:TextRerankerScorer | 0.9129 |
| validation-fundamentals | 基础卷-错误答案 | wrong | fund-choice | 0.0-0.0 | 0.0 | yes | objective_rule | 1.0000 |
| validation-fundamentals | 基础卷-错误答案 | wrong | fund-rest | 0.0-2.0 | 0.0 | yes | subjective_scoring:TextRerankerScorer | 0.4000 |
| validation-fundamentals | 基础卷-错误答案 | wrong | fund-status | 0.0-1.0 | 0.0 | yes | subjective_scoring:TextRerankerScorer | 0.4000 |
| validation-backend | 后端卷-完整答案 | complete | back-tx | 9.0-10.0 | 8.0 | no | subjective_scoring:TextRerankerScorer | 0.4000 |
...
| validation-backend | 后端卷-错误答案 | wrong | back-tx | 0.0-2.0 | 0.0 | yes | subjective_scoring:TextRerankerScorer | 0.4000 |
...
| text-scoring-specialist | 文本主观题评分专项卷-complete | complete | text-1 | 0.0-20.0 | 0.0 | yes | subjective_scoring:TextRerankerScorer | 0.4000 |
...
| text-scoring-specialist | 文本主观题评分专项卷-complete | complete | text-3 | 0.0-20.0 | 0.0 | yes | subjective_scoring:TextRerankerScorer | 0.4000 |
| text-scoring-specialist | 文本主观题评分专项卷-complete | complete | text-4 | 0.0-20.0 | 5.0 | yes | subjective_scoring:TextRerankerScorer | 0.4000 |
...
| text-scoring-specialist | 文本主观题评分专项卷-partial | partial | text-1 | 0.0-20.0 | 12.4 | yes | subjective_scoring:TextRerankerScorer | 0.4000 |
| text-scoring-specialist | 文本主观题评分专项卷-partial | partial | text-2 | 0.0-20.0 | 5.0 | yes | subjective_scoring:TextRerankerScorer | 0.4000 |
| text-scoring-specialist | 文本主观题评分专项卷-partial | partial | text-3 | 0.0-20.0 | 0.0 | yes | subjective_scoring:TextRerankerScorer | 0.4000 |
| text-scoring-specialist | 文本主观题评分专项卷-partial | partial | text-4 | 0.0-20.0 | 10.0 | yes | subjective_scoring:TextRerankerScorer | 0.4000 |
| text-scoring-specialist | 文本主观题评分专项卷-partial | partial | text-5 | 0.0-20.0 | 9.1 | yes | subjective_scoring:TextRerankerScorer | 0.7034 |
...
| text-scoring-specialist | 文本主观题评分专项卷-wrong | wrong | text-3 | 0.0-20.0 | 5.4 | yes | subjective_scoring:TextRerankerScorer | 0.4000 |
| text-scoring-specialist | 文本主观题评分专项卷-wrong | wrong | text-4 | 0.0-20.0 | 0.0 | yes | subjective_scoring:TextRerankerScorer | 0.4000 |
| text-scoring-specialist | 文本主观题评分专项卷-wrong | wrong | text-5 | 0.0-20.0 | 9.9 | yes | subjective_scoring:TextRerankerScorer | 0.5500 |
